package com.tsinbei.roamloc.xposed.hooks.provider
...
import com.tsinbei.roamloc.xposed.utils.diyHook
import com.tsinbei.roamloc.xposed.utils.hook
import com.tsinbei.roamloc.xposed.utils.onceHook
        ...
        run {
            if(cLocationProviderManager.onceHookAllMethod("getCurrentLocation", object: XC_MethodHook() {
                override fun beforeHookedMethod(param: MethodHookParam) {
                    ...
                    if (classCallback.onceHookAllMethod("onLocation", object: XC_MethodHook() {
                        override fun beforeHookedMethod(param: MethodHookParam?) {
