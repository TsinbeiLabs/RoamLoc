package com.tsinbei.roamloc.xposed.hooks.telephony
...
import com.tsinbei.roamloc.xposed.utils.onceHookDoNothingMethod
...
//            )
//        }.onFailure {
//            XposedBridge.log("[RoamLoc] Hook CellIdentityCdma failed")
//        }
...
//
//        }.onFailure {
//            XposedBridge.log("[RoamLoc] Hook CellIdentityGsm failed")
//        }
...
//            }
//        }.onFailure {
//            XposedBridge.log("[RoamLoc] ITelephony.Stub not found: ${it.stackTraceToString()}")
//        }
...
//
//        println("[RoamLoc] found " + cITelephony.declaredMethods.mapNotNull {
//            if (it.returnType.javaClass.name.contains("CellLocation")) {
//                if (FakeLocationConfig.DEBUG) {
//                    XposedBridge.log("[RoamLoc] hook method: $it")
//                }
