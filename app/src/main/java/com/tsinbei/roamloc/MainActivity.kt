...
import com.tsinbei.roamloc.android.permission.RequestPermissions
import com.tsinbei.roamloc.android.root.ShellUtils
import com.tsinbei.roamloc.android.window.OverlayUtils
import com.tsinbei.roamloc.bdmap.Poi
import com.tsinbei.roamloc.bdmap.toPoi
import com.tsinbei.roamloc.databinding.ActivityMainBinding
import com.tsinbei.roamloc.ext.gcj02
import com.tsinbei.roamloc.ext.wgs84
import com.tsinbei.roamloc.ui.notification.NotificationUtils
import com.tsinbei.roamloc.ui.viewmodel.BaiduMapViewModel
import com.tsinbei.roamloc.ui.viewmodel.MockServiceViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showPermissionDeniedToast(permission: String) {
        val message = when (permission) {
            ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION -> "RoamLoc需要完整位置权限"
            ACCESS_LOCATION_EXTRA_COMMANDS -> "RoamLoc需要额外位置命令权限和系统交互"
            CHANGE_WIFI_STATE, ACCESS_WIFI_STATE -> "RoamLoc需要访问Wi-Fi状态"
            READ_PHONE_STATE -> "RoamLoc需要读取设备信息"
            ACCESS_NETWORK_STATE, INTERNET -> "RoamLoc需要访问网络"
            VIBRATE -> "RoamLoc需要访问传感器"
